...
from facts.error_code import ErrorCodeG6000
...
class CannonG6000(Printer):
    ...
    def __init__(self, error_code: ErrorCodeG6000 = None) -> None:
        super().__init__(get_all_component_types_g6000(), error_code)

    # only one with children currently
    def get_child_components(self, component: ComponentTypeG6000) -> List[ComponentTypeG6000]:
        if component == ComponentTypeG6000.AnyPaperTray:
            return [ComponentTypeG6000.BacksidePaperTray, ComponentTypeG6000.FrontCassette]
